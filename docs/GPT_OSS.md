...
2. inserts developer input as LangChain `ChatMessage(role='developer')` in the actual Remote Responses controller path; LibreChat's OpenAI adapter maps that generic role to OpenAI `developer`, and
