    ...
    $('#app').innerHTML = `
      ...
      <div class="compile">
        ...
        ${workspace.lastCompile
          ? `<hr><div class="compile-result-head"><div class="small">${esc(displayTimestamp(workspace.lastCompile.at))}</div><div class="compile-result-actions"><button id="copyCompile" class="sm" type="button">結果をコピー</button><button id="downloadCompile" class="sm" type="button">Markdownで保存</button></div></div><div class="compile-output" id="compileOutput">${renderCompileText(workspace.lastCompile.text)}</div>`
